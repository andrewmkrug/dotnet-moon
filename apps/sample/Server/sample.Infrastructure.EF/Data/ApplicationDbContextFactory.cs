...
/// <code>dotnet ef migrations add Version_0001 --project ../sample.Migrations.SqlServer -- --provider SqlServer</code>
/// 
/// Example for SQLite:
/// <code>dotnet ef migrations add Version_0001 --project ../sample.Migrations.Sqlite -- --provider Sqlite</code>
///
/// /// Example for PostgreSQL:
/// <code>dotnet ef migrations add Version_0001 --project ../sample.Migrations.PostgreSql -- --provider PostgreSql</code>
///
/// /// Example for MySQL:
/// <code>dotnet ef migrations add Version_0001 --project ../sample.Migrations.MySql -- --provider MySql</code>
/// 
    ...
    public ApplicationDbContext CreateDbContext(string[] args)
    {
        ...
        var contextOptions = provider switch
        {
            "Sqlite" => new ApplicationDbContextOptions
            {
                ...
                ConnectionString = "Data Source=localhost;Database=MyDatabase;User Id=myUsername;Password=myPassword;" //"Data Source=Data\\MyDatabase.sqlite"
            },
            "SqlServer" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "SqlServer",
                ConnectionString = "Data Source=localhost;Database=MyDatabase;User Id=myUsername;Password=myPassword;" //"Data Source=.\\SQLEXPRESS; Database=MyDatabase; Integrated Security=true; TrustServerCertificate=true"
            },
            "PostgreSql" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "PostgreSql",
                ConnectionString = "Data Source=localhost;Database=MyDatabase;User Id=myUsername;Password=myPassword;" //"Data Source=localhost; Port=5432; Database=MyDatabase; Username=postgres; Password=postgres"
            },
            "MySql" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "MySql",
                ConnectionString = "Data Source=localhost;Database=MyDatabase;User Id=myUsername;Password=myPassword;" //"Data Source=localhost; Port=3306; Database=MyDatabase; Username=root; Password=root"
            },
